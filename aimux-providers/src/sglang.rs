...
const DEFAULT_BASE_URL: &str = "http://127.0.0.1:30000/v1";
const ENV_VAR: &str = "SGLANG_BASE_URL";
const PROVIDER_NAME: &str = "sglang";
const PLACEHOLDER_API_KEY: &str = "sglang";

pub struct SglangConfig(OpenAIConfig);
