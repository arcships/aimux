...
//! `https://bedrock-mantle.{region}.api.aws/v1`. Provider-specific details are the base URL
//! and the `BEDROCK_MANTLE_API_KEY` environment variable; everything else is delegated
...
const DEFAULT_BASE_URL: &str = "https://bedrock-mantle.{region}.api.aws/v1";
...
impl BedrockMantleProvider {
    ...
    /// Create a model instance (e.g. `us-east-1`).
