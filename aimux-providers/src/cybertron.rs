//! Cybertron (Rust) provider — a thin OpenAI-compatible wrapper.
//!
//! See <github.com/dottorblaster/cybertron> for API documentation. Exposes an OpenAI-compatible
//! Chat Completions API at `http://127.0.0.1:8080/v1`. The `CYBERTRON_BASE_URL` environment
...
const ENV_VAR: &str = "CYBERTRON_BASE_URL";
const PROVIDER_NAME: &str = "cybertron";
const PLACEHOLDER_API_KEY: &str = "cybertron";

pub struct CybertronConfig(OpenAIConfig);

impl CybertronConfig {
...
impl Provider for CybertronProvider {
    fn name(&self) -> &str {
        PROVIDER_NAME
    }
