...
const DEFAULT_BASE_URL: &str = "http://127.0.0.1:9997/v1";
const ENV_VAR: &str = "XINFERENCE_BASE_URL";
const PROVIDER_NAME: &str = "xinference";
const PLACEHOLDER_API_KEY: &str = "xinference";

pub struct XinferenceConfig(OpenAIConfig);
...
impl Provider for XinferenceProvider {
    fn name(&self) -> &str {
        PROVIDER_NAME
    }
