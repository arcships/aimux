//! AI21 models on Vertex AI MaaS — a thin OpenAI-compatible wrapper.
//!
...
const PROVIDER_NAME: &str = "vertex_ai_ai21_models";
...
/// supplied via [`VertexAiAi21ModelsConfig::with_base_url`]; prefer
/// [`VertexAiAi21ModelsConfig::from_env`] or set the project explicitly for real usage.
...
/// Configuration for the AI21 Vertex AI MaaS provider (wraps [`OpenAIConfig`]).
pub struct VertexAiAi21ModelsConfig(OpenAIConfig);

impl VertexAiAi21ModelsConfig {
...
/// AI21 Vertex AI MaaS provider — creates [`OpenAIModel`] instances pointed
...
impl Provider for VertexAiAi21ModelsProvider {
    fn name(&self) -> &str {
        PROVIDER_NAME
    }
