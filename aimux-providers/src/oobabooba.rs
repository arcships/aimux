//! Oobabooga Text Generation WebUI provider — a thin OpenAI-compatible wrapper.
//!
//! See <github.com/oobabooga> for API documentation. Exposes an OpenAI-compatible
//! Chat Completions API at `http://127.0.0.1:5000/v1`. The `OOBABOOBA_BASE_URL` environment
...
const ENV_VAR: &str = "OOBABOOBA_BASE_URL";
const PROVIDER_NAME: &str = "oobabooba";
const PLACEHOLDER_API_KEY: &str = "oobabooba";

pub struct OobaboobaConfig(OpenAIConfig);

impl OobaboobaConfig {
...
impl Provider for OobaboobaProvider {
    fn name(&self) -> &str {
        PROVIDER_NAME
    }
