...
These providers are **not** name-addressable: `provider("anthropic", ...)` fails with `UnknownProvider`. Use the typed entry points below (Rust type names; other bindings cover a subset — see [reference.md](reference.md)).
