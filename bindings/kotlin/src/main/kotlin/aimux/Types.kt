...
sealed interface StreamPart {
    ...
    @Serializable
    data class TextStart(val id: String = "") : StreamPart

    @Serializable
    data class TextDelta(val id: String = "", val delta: String = "") : StreamPart

    @Serializable
    data class TextEnd(val id: String = "") : StreamPart
    ...
    @Serializable
    data class ToolInputDelta(val id: String = "", val delta: String = "") : StreamPart

    @Serializable
    data class ToolInputEnd(val id: String = "") : StreamPart
    ...
    data class ToolResult(
        @SerialName("tool_call_id") val toolCallId: String = "",
        @SerialName("tool_name") val toolName: String = "",
        val output: JsonElement = JsonObject(emptyMap()),
