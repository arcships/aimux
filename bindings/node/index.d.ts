...
/* eslint-disable */
/** Fallible native return — unwraps to `T` at runtime; failures reject/throw a structured error (see src/error.ts). */
export type AimuxResult<T> = T
/** Stream yield — a StreamPart JSON string at runtime; failures reject `next()` with a structured error. */
